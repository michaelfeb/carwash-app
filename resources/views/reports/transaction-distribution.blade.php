...
<head>
    ...
    <title>Transaction Distribution Report</title>
    <style>
        body {
...
<body>
    @include('reports.partials.header', [
        'reportTitle' => 'LAPORAN DISTRIBUSI TRANSAKSI',
    ...
    <div class="summary">
        ...
        <div class="summary-item">
            ...
            <span class="summary-value">Rp {{ number_format($averageDaily, 0, ',', '.') }}</span>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" class="text-center">Tidak ada data pada periode ini</td>
                </tr>
            @endforelse
            @if($dailyData->count() > 0)
                <tr class="total-row">
                    <td colspan="2">TOTAL</td>
                    <td class="text-center">{{ $dailyData->sum('count') }}</td>
